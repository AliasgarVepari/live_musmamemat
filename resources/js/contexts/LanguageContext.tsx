...
const translations = {
  ar: {
    ...
    'auth.phoneInvalid': 'رقم الهاتف يجب أن يكون 8 أرقام',
    ...
    'auth.nameMinLength': 'الاسم يجب أن يكون حرفين على الأقل',
    'auth.confirmPasswordRequired': 'تأكيد كلمة المرور مطلوب',
    'auth.agreeTermsRequired': 'يجب الموافقة على الشروط والأحكام',
    'auth.otpSent': 'تم إرسال رمز التحقق',
    'auth.success': 'نجح',
    'auth.registrationComplete': 'تم إنشاء الحساب بنجاح',
  ...
  en: {
    ...
    'auth.phoneInvalid': 'Phone number must be 8 digits',
    ...
    'auth.agreeTermsRequired': 'You must agree to the Terms & Conditions',
    'auth.otpSent': 'Verification code sent',
    'auth.success': 'Success',
    'auth.registrationComplete': 'Account created successfully',
