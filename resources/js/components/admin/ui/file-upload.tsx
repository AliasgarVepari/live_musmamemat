            ...
            >
                ...
                {displayUrl ? (
                    <div className="flex flex-col items-center space-y-4">
                        <div className="relative">
                            <div className="bg-primary/10 flex h-20 w-20 items-center justify-center rounded-lg">
                                <img src={displayUrl} alt="File preview" className="h-16 w-16 object-contain" />
                            </div>
                            {!disabled && (
                                <button
                                    type="button"
                                    onClick={handleRemoveFile}
                                    className="absolute -right-2 -top-2 z-10 rounded-full bg-red-500 p-1 text-white transition-colors hover:bg-red-600"
                                >
                                    <X className="h-4 w-4" />
                                </button>
                            )}
                        ...
                        <div className="text-center">
                            <p className="text-sm font-medium text-gray-900">{currentFile?.name || 'Current file'}</p>
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-medium text-gray-900">{isDragOver ? 'Drop the file here' : label}</p>
