import BaseLayout from '@/layouts/admin/base-layout';
import { dashboard, login, register } from '@/routes/admin';
import { type SharedData } from '@/types';
import { Head, Link, usePage } from '@inertiajs/react';
import liveMusamematLogo from '@/assets/user/live-m9memat-logo-modified.png';
                ...
                <div className="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-br-none lg:rounded-tl-lg lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium text-2xl">Welcome to Admin Console</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Your premier marketplace for classified ads in Kuwait.
                                <br />
                                Connecting buyers and sellers across the region.
                            </p>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none dark:bg-[#1D0002] flex items-center justify-center">
                            <div className="duration-750 starting:translate-y-6 starting:opacity-0 translate-y-0 opacity-100 transition-all flex flex-col items-center justify-center p-8">
                                <img
                                    src={liveMusamematLogo}
                                    alt="Live Musamemat"
                            ...
                            <svg
                                className="relative -ml-8 -mt-[4.9rem] hidden w-[448px] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:block"
                                viewBox="0 0 440 376"
                                fill="none"
