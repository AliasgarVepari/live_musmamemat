import{r as l,a as D,b as u,j as e,H as _,L as h}from"./app-BFw6crce.js";import{B as c}from"./badge-51q0YhAN.js";import{B as d}from"./button-BY0ac9k0.js";import{C as g,a as f,b as p,d as v,c as j}from"./card-KOH_yNsI.js";import{C as A}from"./confirmation-dialog-IMdAqX3j.js";import{I as z}from"./input-5aRNEnbr.js";import{A as B,T as b}from"./app-layout-BQqLmhiR.js";import{P as E}from"./plus-BH9LLzfR.js";import{S as M}from"./search-CfB6Wjny.js";import{a as $,T as F}from"./toggle-right-Bqzv5Yyu.js";import{S as H}from"./square-pen-w3w0oyHU.js";import{T as O}from"./trash-2-RvYWrrC6.js";import"./index-DLMo7saC.js";import"./dialog-BD5R73NQ.js";import"./index-D0M1C5f8.js";import"./chevron-right-D8KfAi0Y.js";import"./index-zS-_QWp1.js";import"./index-DW9AIAM8.js";import"./base-layout-CvSYQlx-.js";/* empty css            */import"./use-forced-theme-D4zww-dL.js";import"./settings-fj9JBxk_.js";import"./logo-DB6pQEXk.js";import"./map-pin-D0BPMaHw.js";import"./crown--DHapRJn.js";const P=[{title:"Categories",href:"/admin/categories"}];function he({categories:y,filters:C}){const[a,N]=l.useState(""),[i,w]=l.useState(C?.status||"all"),[n,x]=l.useState({open:!1,title:"",description:"",onConfirm:()=>{}}),{url:S}=D();l.useEffect(()=>{localStorage.getItem("admin-categories-refresh")==="true"&&(localStorage.removeItem("admin-categories-refresh"),setTimeout(()=>{u.reload({only:["categories"]})},100))},[S]);const k=(s,r)=>{const o=document.querySelector(".error-dialog-overlay");o&&o.remove();const t=document.createElement("div");t.className="error-dialog-overlay",t.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
