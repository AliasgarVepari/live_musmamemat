import{r as l,a as D,b as u,j as e,H as _,L as h}from"./app-CYWBXX07.js";import{B as c}from"./badge-BkIyZ1R5.js";import{B as d}from"./button-B6GkvJ5X.js";import{C as g,a as f,b as p,d as v,c as j}from"./card-DybFjpwC.js";import{C as A}from"./confirmation-dialog-D4dQmy5P.js";import{I as z}from"./input-DRHktpc4.js";import{A as B,T as b}from"./app-layout-Dehso8KF.js";import{P as E}from"./plus-8cC1jP82.js";import{S as M}from"./search-BNBQVDZj.js";import{a as $,T as F}from"./toggle-right-Dx2oDpFR.js";import{S as H}from"./square-pen-D01_AHQx.js";import{T as O}from"./trash-2-BOfeXSLK.js";import"./index-DK5vjGzq.js";import"./dialog-BEb_vUYn.js";import"./index-CL62j43o.js";import"./index-DdYmH3An.js";import"./chevron-right-DiKejydi.js";import"./index-DS1gS2cN.js";import"./index-DW9AIAM8.js";import"./base-layout-D97316RH.js";/* empty css            */import"./use-forced-theme-HDN5vuZO.js";import"./settings-DB68J-iZ.js";import"./logo-DB6pQEXk.js";import"./map-pin-CKu1rcyW.js";import"./crown-Bebnt4J8.js";const P=[{title:"Categories",href:"/admin/categories"}];function ge({categories:y,filters:C}){const[a,N]=l.useState(""),[i,w]=l.useState(C?.status||"all"),[n,x]=l.useState({open:!1,title:"",description:"",onConfirm:()=>{}}),{url:S}=D();l.useEffect(()=>{localStorage.getItem("admin-categories-refresh")==="true"&&(localStorage.removeItem("admin-categories-refresh"),setTimeout(()=>{u.reload({only:["categories"]})},100))},[S]);const k=(s,r)=>{const o=document.querySelector(".error-dialog-overlay");o&&o.remove();const t=document.createElement("div");t.className="error-dialog-overlay",t.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
