import{r as l,a as D,b as u,j as e,H as _,L as h}from"./app-uIBbFV7s.js";import{B as c}from"./badge-q2x3NqTO.js";import{B as d}from"./button-CmAnywOu.js";import{C as g,a as f,b as p,d as v,c as j}from"./card-BE0sM_ZY.js";import{C as A}from"./confirmation-dialog-Wh_61Jvw.js";import{I as z}from"./input-CJFhTPux.js";import{A as B,T as b}from"./app-layout-Bb8jMqAy.js";import{P as E}from"./plus-2LA9Ba3C.js";import{S as M}from"./search-C9k4RQzq.js";import{a as $,T as F}from"./toggle-right-D1DdtN-a.js";import{S as H}from"./square-pen-NHgyS63q.js";import{T as O}from"./trash-2-CEsYTU9n.js";import"./index-CZeLxcXh.js";import"./dialog-C0q5kByK.js";import"./index-B66VouJH.js";import"./chevron-right-BwP0sTl-.js";import"./index-BESL25gX.js";import"./index-DW9AIAM8.js";import"./base-layout-DG2-1LJI.js";/* empty css            */import"./use-forced-theme-BDmHQh6w.js";import"./settings-C_r1I_dc.js";import"./logo-DB6pQEXk.js";import"./map-pin-CuSYpetG.js";import"./crown-CRR7HS9B.js";const P=[{title:"Categories",href:"/admin/categories"}];function he({categories:y,filters:C}){const[a,N]=l.useState(""),[i,w]=l.useState(C?.status||"all"),[n,x]=l.useState({open:!1,title:"",description:"",onConfirm:()=>{}}),{url:S}=D();l.useEffect(()=>{localStorage.getItem("admin-categories-refresh")==="true"&&(localStorage.removeItem("admin-categories-refresh"),setTimeout(()=>{u.reload({only:["categories"]})},100))},[S]);const k=(s,r)=>{const o=document.querySelector(".error-dialog-overlay");o&&o.remove();const t=document.createElement("div");t.className="error-dialog-overlay",t.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
